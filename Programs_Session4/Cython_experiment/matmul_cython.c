...
static PyObject *__pyx_f_13matmul_cython_matmul1(PyArrayObject *, PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_13matmul_cython_matmul1(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_mat1, PyArrayObject *__pyx_v_mat2, PyArrayObject *__pyx_v_r); /* proto */
...
static PyObject *__pyx_pw_13matmul_cython_1matmul1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_13matmul_cython_matmul1(PyArrayObject *__pyx_v_mat1, PyArrayObject *__pyx_v_mat2, PyArrayObject *__pyx_v_r, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  size_t __pyx_t_16;
  size_t __pyx_t_17;
  __Pyx_RefNannySetupContext("matmul1", 0);
  ...
  __pyx_pybuffernd_r.rcbuffer = &__pyx_pybuffer_r;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mat1.rcbuffer->pybuffer, (PyObject*)__pyx_v_mat1, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mat2.rcbuffer->pybuffer, (PyObject*)__pyx_v_mat2, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_r.rcbuffer->pybuffer, (PyObject*)__pyx_v_r, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
  }
 ...
 *     c2 = mat2.shape[1]
 */
  __pyx_v_r1 = (__pyx_v_mat1->dimensions[0]);

  /* "matmul_cython.pyx":33
 * 
 *     r1 = mat1.shape[0]
 *     r2 = mat2.shape[0]             # <<<<<<<<<<<<<<
 *     c2 = mat2.shape[1]
 * 
 */
  __pyx_v_r2 = (__pyx_v_mat2->dimensions[0]);

  /* "matmul_cython.pyx":34
 *     r1 = mat1.shape[0]
 *     r2 = mat2.shape[0]
 *     c2 = mat2.shape[1]             # <<<<<<<<<<<<<<
 * 
 *     # r[:,:] = 0.0
 */
  __pyx_v_c2 = (__pyx_v_mat2->dimensions[1]);

  /* "matmul_cython.pyx":38
 *     # r[:,:] = 0.0
 * 
 *     for i in range(0, r1):             # <<<<<<<<<<<<<<
 *         for j in range(0, c2):
 ...
 */
      ...
      __pyx_t_6 = __pyx_v_j;
      __pyx_t_7 = -1;
      if (unlikely(__pyx_t_5 >= (size_t)__pyx_pybuffernd_r.diminfo[0].shape)) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_6 >= (size_t)__pyx_pybuffernd_r.diminfo[1].shape)) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 40, __pyx_L1_error)
      }
      *__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_r.diminfo[0].strides, __pyx_t_6, __pyx_pybuffernd_r.diminfo[1].strides) = 0.0;

      /* "matmul_cython.pyx":42
 *             r[i,j] = 0.0
 *             # r[i][j] = 0.0
 *             for k in range(0, r2):             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __pyx_v_r2;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_k = __pyx_t_9;

        /* "matmul_cython.pyx":44
 *             for k in range(0, r2):
 *                 # r[i,j] += mat1[i,k]*mat2[k,j]
 *                 r[i,j] = r[i,j] + mat1[i,k]*mat2[k,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_7 = -1;
        if (unlikely(__pyx_t_10 >= (size_t)__pyx_pybuffernd_r.diminfo[0].shape)) __pyx_t_7 = 0;
        if (unlikely(__pyx_t_11 >= (size_t)__pyx_pybuffernd_r.diminfo[1].shape)) __pyx_t_7 = 1;
        if (unlikely(__pyx_t_7 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_7);
        ...
        __pyx_t_7 = -1;
        if (unlikely(__pyx_t_12 >= (size_t)__pyx_pybuffernd_mat1.diminfo[0].shape)) __pyx_t_7 = 0;
        if (unlikely(__pyx_t_13 >= (size_t)__pyx_pybuffernd_mat1.diminfo[1].shape)) __pyx_t_7 = 1;
        if (unlikely(__pyx_t_7 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_7);
          __PYX_ERR(0, 44, __pyx_L1_error)
        }
        ...
        __pyx_t_7 = -1;
        if (unlikely(__pyx_t_14 >= (size_t)__pyx_pybuffernd_mat2.diminfo[0].shape)) __pyx_t_7 = 0;
        if (unlikely(__pyx_t_15 >= (size_t)__pyx_pybuffernd_mat2.diminfo[1].shape)) __pyx_t_7 = 1;
        if (unlikely(__pyx_t_7 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_7);
          __PYX_ERR(0, 44, __pyx_L1_error)
        }
        ...
        __pyx_t_7 = -1;
        if (unlikely(__pyx_t_16 >= (size_t)__pyx_pybuffernd_r.diminfo[0].shape)) __pyx_t_7 = 0;
        if (unlikely(__pyx_t_17 >= (size_t)__pyx_pybuffernd_r.diminfo[1].shape)) __pyx_t_7 = 1;
        if (unlikely(__pyx_t_7 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_7);
          __PYX_ERR(0, 44, __pyx_L1_error)
        }
        *__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_r.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_r.diminfo[1].strides) = ((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_r.diminfo[0].strides, __pyx_t_11, __pyx_pybuffernd_r.diminfo[1].strides)) + ((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_mat1.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_mat1.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_mat1.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_mat2.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_mat2.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_mat2.diminfo[1].strides))));
      }
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("matmul_cython.matmul1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mat1.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_13matmul_cython_1matmul1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13matmul_cython_1matmul1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_mat1 = 0;
  PyArrayObject *__pyx_v_mat2 = 0;
  PyArrayObject *__pyx_v_r = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("matmul1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_mat1,&__pyx_n_s_mat2,&__pyx_n_s_r,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mat2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("matmul1", 1, 3, 3, 1); __PYX_ERR(0, 27, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matmul1", 1, 3, 3, 2); __PYX_ERR(0, 27, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "matmul1") < 0)) __PYX_ERR(0, 27, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("matmul1", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 27, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("matmul_cython.matmul1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mat1), __pyx_ptype_5numpy_ndarray, 1, "mat1", 0))) __PYX_ERR(0, 27, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mat2), __pyx_ptype_5numpy_ndarray, 1, "mat2", 0))) __PYX_ERR(0, 27, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_r), __pyx_ptype_5numpy_ndarray, 1, "r", 0))) __PYX_ERR(0, 27, __pyx_L1_error)
  __pyx_r = __pyx_pf_13matmul_cython_matmul1(__pyx_self, __pyx_v_mat1, __pyx_v_mat2, __pyx_v_r);
...
static PyObject *__pyx_pf_13matmul_cython_matmul1(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_mat1, PyArrayObject *__pyx_v_mat2, PyArrayObject *__pyx_v_r) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mat1;
  __Pyx_Buffer __pyx_pybuffer_mat1;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mat2;
  __Pyx_Buffer __pyx_pybuffer_mat2;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_r.rcbuffer->pybuffer, (PyObject*)__pyx_v_r, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
  }
  __pyx_pybuffernd_r.diminfo[0].strides = __pyx_pybuffernd_r.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_r.diminfo[0].shape = __pyx_pybuffernd_r.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_r.diminfo[1].strides = __pyx_pybuffernd_r.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_r.diminfo[1].shape = __pyx_pybuffernd_r.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_13matmul_cython_matmul1(__pyx_v_mat1, __pyx_v_mat2, __pyx_v_r, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"matmul1", (PyCFunction)__pyx_pw_13matmul_cython_1matmul1, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmatmul_cython(void); /*proto*/
PyMODINIT_FUNC initmatmul_cython(void)
#else
PyMODINIT_FUNC PyInit_matmul_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_matmul_cython(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_matmul_cython(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "matmul_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "matmul_cython", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init matmul_cython", 0, __pyx_lineno, __pyx_filename);
    }
